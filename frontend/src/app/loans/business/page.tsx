...
import { ArrowRight, Building2, Check, Percent, TrendingUp, Users, Target } from 'lucide-react';
...
const features = [
  ...
  'Working capital & expansion loans available',
];
    ...
    <main>
      <section className="relative overflow-hidden bg-gradient-to-br from-premium-blue via-premium-blue to-premium-dark">
        ...
        <div className="relative mx-auto max-w-[1400px] px-8 py-24">
          <div className="flex items-center gap-2 text-premium-gold text-sm font-semibold mb-4">
            <Building2 className="h-5 w-5" /> Business Loan
          </div>
          <h1 className="text-5xl font-bold text-white tracking-tight">
            Fuel Your{' '}
            <span className="text-premium-gold">Business Growth</span>
          </h1>
          <p className="mt-4 text-lg text-white/70 max-w-xl">Business loans starting at 12% p.a. with flexible tenures and customized solutions.</p>
      ...
      <section className="bg-white py-24">
        <div className="mx-auto max-w-[1400px] px-8">
          <div className="grid gap-12 lg:grid-cols-2 items-center">
            <div>
              <span className="text-xs font-semibold uppercase tracking-[0.2em] text-premium-blue">Business Finance</span>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                { label: 'Starting Rate', value: '12%', icon: Percent },
                { label: 'Max Loan', value: '₹2 Cr', icon: Target },
                { label: 'Max Tenure', value: '10 Years', icon: TrendingUp },
                { label: 'Disbursal', value: '72 Hours', icon: Users },
              ].map((s) => (
      ...
      <section className="bg-gradient-to-r from-premium-blue to-premium-dark py-16">
        <div className="mx-auto max-w-[1400px] px-8 text-center">
          ...
          <p className="text-white/70 mt-3 max-w-lg mx-auto">Customized business loans to help you scale and succeed.</p>
          <Link href="/auth/register" className="inline-flex items-center gap-2 rounded-xl bg-premium-gold text-premium-dark px-8 py-3.5 font-semibold mt-8 hover:bg-premium-gold/90 hover:scale-105 transition-all shadow-lg shadow-premium-gold/25">
            Apply for Business Loan <ArrowRight className="h-4 w-4" />
          </Link>
        </div>
      </section>
    </main>
